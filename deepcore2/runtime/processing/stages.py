...
from deepcore2.runtime.processing.runtime import ProcessingResult
...
class RelationshipStage:
    ...
    def execute(self, db: Session, sync_result: SyncResult, pipeline_result: ProcessingResult) -> None:
        from deepcore2.intelligence.relationship_engine import RelationshipEngine
...
class SignalStage:
    ...
    def execute(self, db: Session, sync_result: SyncResult, pipeline_result: ProcessingResult) -> None:
        from deepcore2.intelligence.signal_engine import SignalEngine
        workspace_id = pipeline_result.context["workspace_id"]
