...
from deepcore2.runtime.descriptors import CapabilityRegistry, ProviderDescriptor
from deepcore2.core.acquisition.manager import AcquisitionManager

logger = logging.getLogger("deepcore2.acquisition.loader")


class ConnectorLoader:
    """
    Dynamically discovers and loads connector modules from deepcore2.connectors,
    ...
    def __init__(
        ...
        package_name: str = "deepcore2.connectors"
    ):
