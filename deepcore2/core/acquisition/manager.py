...
from deepcore2.runtime.descriptors import ProviderDescriptor
from deepcore2.core.acquisition.base import BaseConnector, BaseTranslator

logger = logging.getLogger("deepcore2.acquisition.manager")
