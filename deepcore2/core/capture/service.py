...
from deepcore2.core.providers.youtube import YouTubeProvider
from deepcore2.core.providers.github import GitHubProvider
from deepcore2.core.providers.web import WebProvider

from deepcore2.core.objects.schemas import RegistryObjectUpdate
...
class CaptureService:
    ...
    def process_embedded_resources(self, db_obj: Any, processed_urls: Set[str], raw_text_content: str = "", stats: Optional[dict] = None) -> None:
        ...
        from deepcore2.intelligence.object_detector import ObjectDetector
